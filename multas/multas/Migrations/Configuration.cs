        ...
        protected override void Seed(multas.Models.ApplicationDbContext context)
        {
            ...
            var agentes = new List<Agentes> {
               ...
               new Agentes {ID=3,
                           Nome ="André Silveira",
                           Esquadra ="Abrantes",
                           Fotografia ="AndreSilveira.jpg",
                           UserNameId ="agente@multas.pt" },
               new Agentes {ID=4,
                           Nome ="Lurdes Vieira",
                           Esquadra ="Leiria",
                           Fotografia ="LurdesVieira.jpg",
                           UserNameId =""},
               new Agentes {ID=5,
                           Nome ="Cláudia Pinto",
                           Esquadra ="Porto",
                           Fotografia ="ClaudiaPinto.jpg",
                           UserNameId =""},
               new Agentes {ID=6,
                           Nome ="Rui Vieira",
                           Esquadra ="Tomar",
                           Fotografia ="RuiVieira.jpg",
                           UserNameId =""},
               new Agentes {ID=7,
                           Nome ="Paulo Vieira",
                           Esquadra ="Torres Novas",
                           Fotografia ="PauloVieira.jpg",
                           UserNameId =""},
               new Agentes {ID=8,
                           Nome ="Augusto Carvalho",
                           Esquadra ="Lisboa",
                           Fotografia ="AugustoCarvalho.jpg",
                           UserNameId =""},
               new Agentes {ID=9,
                           Nome ="Beatriz Pinto",
                           Esquadra ="Porto",
                           Fotografia ="BeatrizPinto.jpg",
                           UserNameId =""},
               new Agentes {ID=10,
                           Nome ="José Alves",
                           Esquadra ="Alcanena",
                           Fotografia ="JoseAlves.jpg",
                           UserNameId =""}
                    };
